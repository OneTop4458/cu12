...
7. If a CU12 run exceeds the chunk budget, enqueue a continuation AUTOLEARN job. Cyber Campus runs stop at the per-request budget and require a new request for remaining lessons.
