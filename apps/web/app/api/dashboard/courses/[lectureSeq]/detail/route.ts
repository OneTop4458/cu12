...
export async function GET(request: NextRequest, { params }: Params) {
  try {
    ...
    console.error("[dashboard/course-detail] failed", error);
    return jsonError("Dashboard course detail failed. Please refresh and try again.", 503, "DASHBOARD_COURSE_DETAIL_FAILED");
  }
}
