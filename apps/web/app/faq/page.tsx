...
const FAQ_ITEMS = [
  {
    ...
    answers: [
      ...
      "필요한 경우 동기화 또는 자동학습 요청이 접수되며, 백그라운드 작업이 완료되면 결과와 알림이 반영됩니다. 최초 이용 시에는 초대코드 검증 절차를 거쳐 계정이 등록됩니다.",
    ],
  },
  {
  ...
  {
    question: "초대코드가 필요한 이유와 동작 방식은 무엇인가요?",
    answers: [
      "본 서비스는 동기화, 자동학습, 메일 알림, 백그라운드 작업 처리 등 지속적인 서버 자원을 사용합니다. 운영 가능한 사용자 수와 작업량을 관리하기 위해 최초 이용 시 초대코드 기반 승인 절차를 두고 있습니다.",
      "초대코드는 1회용이며 특정 계정 ID에 맞추어 발급됩니다. 유효기간이 경과하였거나 이미 사용된 코드는 다시 사용할 수 없으며, 다른 계정에 발급된 초대코드 역시 사용할 수 없습니다.",
    ],
  },
] as const;
    ...
    <main className="dashboard-main page-shell faq-main">
      <section className="card faq-hero">
        <div className="faq-hero-copy">
          ...
          <h1>자주 묻는 질문</h1>
          <p className="muted">
            계정 연동 방식, 지원 범위, 자동화 정책, 초대 절차와 관련하여 자주 접수되는 문의를 정리했습니다.
          </p>
